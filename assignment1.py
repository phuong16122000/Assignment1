...
Name:
Date started:
GitHub URL:https://github.com/phuong16122000/Assignment1.git
"""
''''Here are the global lists which will be used in the function, also the command to open the movies.csv file. I 
...
def main():
    """..."""
    print("Movies To Watch 1.0 - by Phuong Vu")
    main_menu()
